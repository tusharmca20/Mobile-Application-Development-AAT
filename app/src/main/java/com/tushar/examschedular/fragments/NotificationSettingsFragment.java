...
import com.tushar.examschedular.activities.SettingsActivity;
import com.tushar.examschedular.profiles.ProfileManagement;
import com.tushar.examschedular.receivers.DailyReceiver;
...
public class NotificationSettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setNotif();
        Preference myPref = findPreference("examschedularNotif");
    ...
    private void setNotif() {
        boolean show = PreferenceManager.getDefaultSharedPreferences(requireContext()).getBoolean("examschedularNotif", true);
